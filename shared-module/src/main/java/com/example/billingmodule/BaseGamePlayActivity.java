    ...
    public void onDriveButtonClicked(View arg0) {
        ...
        if (mViewController.isTankEmpty()) {
            ...
            try {
                ...
                MediaPlayer ring = MediaPlayer.create(BaseGamePlayActivity.this, R.raw.car);
                ring.start();
                TranslateAnimation moveLefttoRight = new TranslateAnimation(0, 1500, 0, 0);
                moveLefttoRight.setDuration(1000);
                moveLefttoRight.setFillAfter(true);
                mCarImageView.startAnimation(moveLefttoRight);
